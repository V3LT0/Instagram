...
from .views import HomeView, LoginView, RegisterView, LegalView, ContactView, ProfileDetailView, ProfileUpdateView, logout_view, ProfileListView
...
urlpatterns = [
    ...
    path('posts/like_akax/<pk>/', like_post_ajax, name='post_like_ajax'),
