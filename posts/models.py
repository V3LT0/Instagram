...
class Post(models.Model):
    ...
    caption = models.TextField(max_length=500, blank=True, verbose_name='Descripcíon')
    created_at = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de cración')
