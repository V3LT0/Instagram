...
class Follow(models.Model):
    follower = models.ForeignKey(UserProfiles, verbose_name = '¿Quíen sigue?', on_delete=models.CASCADE, related_name='follower_set')
    following = models.ForeignKey(UserProfiles, verbose_name = '¿A quíen sigue?', on_delete=models.CASCADE, related_name='following_set')
